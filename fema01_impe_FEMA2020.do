...
//  task:     	Import "fema_national-household-survey-raw-data-and-weights_2020.xlsx" and save to Derived folder
/*  data:    */ di "`dataset'"
...
import excel ///
$source/fema_national-household-survey-raw-data-and-weights_2020.xlsx, ///
	sheet("2020 NHS - Raw Data and Weights") ///
	firstrow clear

rename weights combwtall
...
notes: fema`category'_`dataset'.dta \ FEMA National Household Survey 2020 \ fema`category'_`dataset'.do mmk $S_DATE
compress
datasignature set
